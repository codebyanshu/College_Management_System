...
const SideBarInHome = () => {
  return (
    <>
      <aside
        id="default-sidebar"
        class="sticky top-19 left-0  w-80 h-screen my-[-1px]"
        aria-label="Sidenav"
      >
        <div class="overflow-y-auto py-1 px-3 h-full bg-white border-r border-gray-400 dark:bg-blue-500 dark:border-gray-700">
          <ul class="space-y-2">
            <li>
              <a
                href="#"
              ...
              >
                <span class="ml-1">Current session : 2024-2028</span>
              </a>
            </li>
            <li>
              <button
                type="button"
                class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-blue-700"
              ...
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                <li>
                  <a
                    href="#"
                    class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-blue-700"
                  >
                    <MdOutlineSchedule />
                ...
                <li>
                  ...
                  >
                    <RiProfileFill />
                    <span className="ml-3"> Attendence</span>
                  </a>
                </li>
                <li>
                  <a
            ...
            <li>
              ...
              <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                <li>
                  <a
                    href="#"
                    class="flex items-center p-2 pl-11 w-full text-base font-normal text-blue-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-blue-700"
                  >
                    MST Results
                  </a>
                </li>
