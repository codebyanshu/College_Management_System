    ...
    <>
      <section class="bg-gray-50 dark:bg-gray-900 max-sm:mt-[5rem] mt-[2rem] max-sm:h-[83vh] h-[100vh] " >
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-full lg:py-0">
          ...
          >
            <p className="text-shadow-lg dark:text-shadow-blue-600">
              Student Login
            </p>
          </a>
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                <div>
                  ...
                  <input
                    ...
                    placeholder="name@company.com/12345"
                    required=""
                  />
                </div>
                <div>
                ...
                <p class="text-sm font-light text-gray-500 dark:text-white-400">
